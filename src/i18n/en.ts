...
export const en: Record<TranslationKey, unknown> = {
  ...
  browse: 'browse',
  ocrHint: 'Supports screenshots from brokers — AI will recognize and extract holdings',
  ocrProcessing: 'AI is analyzing the image...',
  ocrProcessingHint: 'Extracting portfolio data from screenshot',
  ocrDetected: 'Holdings detected from image',
  ocrFailed: 'Image recognition failed',
